...
import { Home, MapPin, BarChart2, FileText, Bell, Settings, Menu } from "lucide-react"
    ...
    return (
        ...
        >
            <div className="flex items-center h-16 px-4">
                {!collapsed && <span className="text-primary font-bold text-xl">LEW System</span>}
                <Button variant="ghost" className="ml-auto" size="icon" onClick={toggleSidebar}>
                    <Menu size={20} />
                </Button>
            </div>
            ...
            <div className="p-4">
                <div className={cn("rounded-md bg-primary/10 p-4 text-primary text-center", collapsed && "p-2")}>
                    {collapsed ? (
                        <Bell size={20} />
                    ) : (
                        <>
