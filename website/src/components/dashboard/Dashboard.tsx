      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Pemantauan sensor dan status peringatan tanah longsor
          </p>
        </div>
        <div>
          <Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {sensors.map((sensor) => (
          <Card key={sensor.id} className={`border-l-4 ${
            sensor.status === 'safe' ? 'border-status-safe' : 
            sensor.status === 'warning' ? 'border-status-warning' : 
            ...
            <CardHeader>
              <CardTitle className="flex justify-between items-center">
                ...
                <div className={`status-indicator ${
                  sensor.status === 'safe' ? 'status-safe' : 
